...
unset($__errorArgs, $__bag); ?>" name="password"  autocomplete="new-password" placeholder="Mínimo 8 caracteres">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="password-confirm" type="password" class="form-control" name="password_confirmation"  autocomplete="new-password" placeholder="Mínimo 8 caracteres">
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH A:\LARAVEL SOTECJOR\MQUA\resources\views/auth/passwords/reset.blade.php ENDPATH**/ ?>