...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-10">
            <div class="card-title text-center" style="margin-top:5px; font-size: large;color:#358180;"><i class="fa-solid fa-stopwatch fa-fw fa-2xl"></i>TEMPORIZADOR<i class="fa-solid fa-stopwatch fa-fw fa-2xl"></i></div>
            <div class="card-body">
                <div class="container">
                    <div id="contenedorInputs">
                        <div class="row col-12 form-group">
                            <div class="col-2 " style="margin-left: 310px;">
            ...
            <br>
            <div class="card-title text-center" style="margin-top:5px ;font-size: large;color:#358180;"><i class="fa-solid fa-hourglass-end fa-fw fa-2xl"></i>POMODORO<i class="fa-solid fa-hourglass-start  fa-fw fa-2xl"></i></div>
                    <div class="card-body">
                        <div class="container">
                            <br>
                            <figure class="clock">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH A:\LARAVEL SOTECJOR\MQUA\resources\views/temporizador-pomodoro/index.blade.php ENDPATH**/ ?>