                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped" id="finanzas">
                            <thead class="text-white" style="background:#358180">
                                ...
                                <th class="table-th text-white text-center" style="width: 70px;"> Acciones</th>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Laravel-SENA\MasQueUnaAgenda\resources\views/finanzas/index.blade.php ENDPATH**/ ?>