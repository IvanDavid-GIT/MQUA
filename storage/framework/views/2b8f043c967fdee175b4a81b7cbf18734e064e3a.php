...
unset($__errorArgs, $__bag); ?>" name="password" autocomplete="current-password">
                                    <div class="input-group-append">
                                        <button id="show_password" class="btn btn" type="button" onclick="mostrarPassword()" style="background-color:#00AA88;"> <span class="fa fa-eye-slash icon" style="color:white"></span> </button>
                                    </div>
                                </div>
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-8 offset-md-4">
                                <button type="submit" class="btn btn-success" color="#00AA88">
                                    <?php echo e(__('Iniciar sesión')); ?>

                                </button>

                                <?php if(Route::has('password.request')): ?>
                                <a class="btn btn-secondary" href="<?php echo e(route('password.request')); ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH A:\LARAVEL SOTECJOR\SotecjorSoft\resources\views/auth/login.blade.php ENDPATH**/ ?>